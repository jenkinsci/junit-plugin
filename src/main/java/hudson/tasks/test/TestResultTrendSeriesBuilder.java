...
public class TestResultTrendSeriesBuilder extends SeriesBuilder<TestResultAction> {
    ...
    @Override
    protected Map<String, Integer> computeSeries(TestResultAction testResultAction) {
